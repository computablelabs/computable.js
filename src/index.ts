...
import { ComputableConfig } from "./types";

export default class Computable {
    ...
    constructor(web3Provider: Web3.Provider, config: ComputableConfig = {}) {
        ...
        this.blockchain = new BlockchainAPI(this.web3);
    }
}
