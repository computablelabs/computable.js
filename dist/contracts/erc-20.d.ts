...
export default class extends Deployed {
    ...
    decreaseApproval(spender: string, amount: Nos, opts?: TransactOpts): Promise<Return>;
    getDecimals(opts?: TransactOpts): Promise<Return>;
    getSymbol(opts?: TransactOpts): Promise<Return>;
    increaseApproval(spender: string, amount: Nos, opts?: TransactOpts): Promise<Return>;
