...
def test_initialized(crowdsale, token, beneficiary):
...
def test_buy_rounded_to_zero(open_crowdsale, token, customer, beneficiary, web3):
...
def test_buy_too_many_tokens(open_crowdsale, token, customer, beneficiary, web3):
...
def test_buy_tokens_too_early(early_crowdsale, token, customer, beneficiary, web3):
...
def test_call_check_goal_reached_too_early(open_crowdsale, token, customer, beneficiary, web3):
...
def test_call_check_goal_reached_after_close(finished_crowdsale, token, customer, beneficiary, web3):
...
def test_check_goal_not_reached(open_crowdsale: Contract, token: Contract, customer, beneficiary, web3, end):
...
def test_no_transfer_before_close(open_crowdsale, token, customer, beneficiary, empty_address, web3, end):
...
def test_refund(open_crowdsale, token, customer, beneficiary, multisig, empty_address, web3, end):
    ...
    assert web3.eth.getBalance(multisig) > multisig_original_balance + Web3.toWei(20, "ether") - 500000
